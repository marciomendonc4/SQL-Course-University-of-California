...
DROP TABLE IF EXISTS fireCallsPartitioned2;

CREATE TABLE IF NOT EXISTS fireCallsPartitioned2
USING DELTA
...
-- MAGIC 
-- MAGIC %fs ls dbfs:/user/hive/warehouse/databricks.db/firecallspartitioned2
...
-- TODO
DESCRIBE HISTORY fireCallsPartitioned2;
